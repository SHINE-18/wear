...
export const applications: Application[] = [
  ...
  },
  {
    ...
    num: '04',
    title: 'Bucket Elevators & Conveyors',
    ...
    specs: [
      { label: 'Coverage', value: 'Continuous & Centrifugal Elevators' },
  ...
  },
  {
    ...
    eyebrow: 'Application 07 / 07',
    description: [
      'WearGuard bucket tips are engineered to deliver dependable penetration, impact resistance and long service life in harsh earthmoving conditions. Manufactured in high wear resistant alloys and application-matched materials, they help reduce change-outs, protect adapters and improve machine productivity.',
      'From general excavation to abrasive rock handling, our tip systems are built for strength, consistent fitment and reliable performance where wear, shock and material flow demand more every day on tough working sites.',
    ],
    specs: [
      { label: 'Application', value: 'General Excavation to Abrasive Rock' },
      { label: 'Material', value: 'High Wear Resistant Alloys' },
    ...
    subComponents: [
      {
        ...
        specs: [
          ...
          { label: 'Impact Resistance', value: 'High Shock Absorbing Alloy' },
          { label: 'Fitment', value: 'Standard & Custom Machine Adapters' },
        ],
      },
      {
        id: 'rock-tips',
        ...
        specs: [
          ...
          { label: 'Metallurgy', value: 'High Wear Resistant Alloys' },
          { label: 'Adapter Protection', value: 'Extended Lip Shield Design' },
        ],
      },
      {
        ...
        specs: [
          ...
          { label: 'Ground Matching', value: 'Tailored to Site Abrasiveness' },
          { label: 'Field Target', value: 'Reduced Change-Outs & Higher Uptime' },
        ],
      },
    ],
    engineeringSupport: {
...
export const materialGrades: MaterialGrade[] = [
  {
    code: '01',
    name: 'WearGuard P400',
    category: 'Quenched & Tempered Martensitic Plate',
    hardness: '400 BHN',
    impactResistance: 'High (30 J at -40°C)',
    tempLimit: 'Up to 250°C',
    composition: '0.22% C · 1.50% Mn · 1.20% Cr · 0.25% Mo · Boron micro-alloyed',
    primaryUse: 'Liners, chutes, buckets and similar components',
    desc: 'Recommended for normal wear applications in asphalt, cement, mining and steel industries. Ideal for liners, chutes, buckets and similar components.',
    highlights: [
      'Recommended for normal wear in asphalt, cement, mining & steel',
      'Precision CNC profile cutting & beveling to ±0.5mm',
      'Ideal for liners, chutes, buckets and similar components',
    ],
    image: '/images/hardfaced-plate.webp',
  },
  {
    ...
    category: 'Quenched & Tempered Martensitic Plate',
    hardness: '450 BHN',
    impactResistance: 'High Toughness',
    tempLimit: 'Up to 250°C',
    composition: '0.24% C · 1.50% Mn · 1.30% Cr · 0.30% Mo · Boron micro-alloyed',
    primaryUse: 'Mixer liners & heavy-duty components',
    desc: 'For high wear applications in asphalt, mining and steel industries. Suitable for heavy-duty components such as mixer liners.',
    highlights: [
      'For high wear applications in asphalt, mining and steel',
      'Suitable for heavy-duty components such as mixer liners',
  ...
  },
  {
    ...
    primaryUse: 'Mixer tips, wear edges, screen decks & crusher chutes',
    desc: 'For superior high wear applications in asphalt, cement, mining and steel industries. Ideal for mixer tips and wear edges.',
    highlights: [
      'Superior high wear resistance in asphalt, cement, mining & steel',
  ...
  {
    code: '04',
    name: 'EnduraCast Z-Core / Ultra / Z-Core Max Liners',
    category: 'Abrasion-Resistant Cast Liners (58–65 HRC)',
    hardness: '58–65 HRC',
    impactResistance: 'High-Impact Abrasion Resistant',
    tempLimit: 'High-Temperature Recycling Rated',
    composition: 'High-Alloy Matrix (6 to 24 mm / 100% to 20 mm)',
    primaryUse: 'Asphalt, cement, mining & steel recycling and extreme wear zones',
    desc: 'For extreme abrasive and erosive wear applications in asphalt, cement, mining and steel industries. Available in Z-Core (6 to 24 mm), Ultra Liners (best for recycling needs), and Z-Core Max Liners (best for high-temperature recycling).',
    highlights: [
      'EnduraCast Z-Core: 58–62 HRC for extreme abrasive & erosive wear (6–24 mm)',
      'EnduraCast Ultra: 60–65 HRC, best for recycling needs in asphalt, cement & mining',
      'EnduraCast Z-Core Max: 60–65 HRC, best for high-temperature recycling needs',
    ],
    image: '/images/mixer-shaft-&-arms.webp',
  },
  {
    ...
    hardness: '550–680+ BHN / Carbide Lining',
    impactResistance: 'Medium to Severe Impact Certified',
    tempLimit: 'Up to 950°C Continuous Service',
    composition: 'Wearcast 600 · Wearcast Ultra 800 · Wearcast Max 1100 (carbide lining)',
    primaryUse: 'Asphalt, cement, mining and steel high-wear casting components',
    desc: 'Engineered foundry grades for abrasive and erosive wear applications in asphalt, cement, mining and steel industries. Ranging from Wearcast 600 and Ultra 800 to Wearcast Max 1100 with carbide lining for maximum performance.',
    highlights: [
      'Wearcast 600: For abrasive & erosive wear in asphalt, cement, mining & steel',
      'Wearcast Ultra 800: For extreme abrasive & high erosive wear environments',
      'Wearcast Max 1100: With carbide lining for maximum performance in asphalt & steel',
    ],
...
export const materials = [
  { name: 'WearGuard P400 / P450 / P500', hardness: '400–500 BHN', desc: 'CNC profiled and cut-to-shape plate for normal to superior high wear applications.' },
  { name: 'EnduraCast Z-Core / Ultra / Max', hardness: '58–65 HRC', desc: 'Tough, abrasion-resistant cast liners engineered for extreme wear and recycling needs.' },
  { name: 'Wearcast 600 / Ultra 800 / Max 1100', hardness: '550–680+ BHN', desc: 'Specialized foundry grades with optional carbide lining for extreme abrasive performance.' },
  { name: 'Ceramic-Rubber Composite Liners', hardness: '9 Mohs / 95% Al2O3', desc: 'Hexagonal alumina ceramic tiles vulcanized in rubber for high-drop impact chutes.' },
...
export const faqs = [
  ...
  },
  {
    ...
    a: 'Standard custom-engineered casting runs typically ship in 6–8 weeks depending on pattern requirements, alloy specification, and ultrasonic/CMM dimensional QA verification.',
  },
  {
