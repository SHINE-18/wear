...
- **`--orange` (`#C8370B`)**: Primary precision heat-treatment accent / brand signature (burnished furnace red-orange).
- **`--orange-hover` (`#D84112`)**: Lighter luminous molten orange for reactive hover states.
- **`--orange-glow` (`rgba(200, 55, 11, 0.35)`)**: Tactical focus states & active spine indicator.
