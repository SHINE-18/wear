...
import { SOCIAL_LINKEDIN, SOCIAL_YOUTUBE, COPYRIGHT_YEAR, COMPANY_NAME, COMPANY_TAGLINE } from '@/lib/site-facts'
      ...
      <div className={`${styles['footer-main-dark']} footer-main-dark`}>
        ...
        <div className={styles['footer-bottom-bar']}>
          ...
          <div className={styles['footer-social-icons']}>
            {SOCIAL_LINKEDIN && (
              <a href={SOCIAL_LINKEDIN} target="_blank" rel="noopener noreferrer nofollow" aria-label="LinkedIn">
            ...
            {SOCIAL_YOUTUBE && (
              <a href={SOCIAL_YOUTUBE} target="_blank" rel="noopener noreferrer nofollow" aria-label="YouTube">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
